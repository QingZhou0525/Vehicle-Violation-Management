...
public class UserRegistration extends JFrame {
	...
	public UserRegistration() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(UserRegistration.class.getResource("/photo/caricon.png")));
		setTitle("新用户注册");
		...
		id_label.setIcon(new ImageIcon(UserRegistration.class.getResource("/photo/user.png")));
		...
		name_label.setIcon(new ImageIcon(UserRegistration.class.getResource("/photo/name.png")));
		...
		sex_label.setIcon(new ImageIcon(UserRegistration.class.getResource("/photo/性别.png")));
		sex_label.setBounds(25, 58, 71, 23);
		contentPane.add(sex_label);
		
		JLabel tel_label = new JLabel("：");
		tel_label.setIcon(new ImageIcon(UserRegistration.class.getResource("/photo/电 话.png")));
		...
		email_label.setIcon(new ImageIcon(UserRegistration.class.getResource("/photo/邮箱.png")));
		...
		licence_label.setIcon(new ImageIcon(UserRegistration.class.getResource("/photo/驾驶证.png")));
		...
		identity_label.setIcon(new ImageIcon(UserRegistration.class.getResource("/photo/身份证.png")));
		...
		pwd_label.setIcon(new ImageIcon(UserRegistration.class.getResource("/photo/密码.png")));
