...
public class UserNoticeDetail extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					UserNoticeDetail frame = new UserNoticeDetail();
	 ...
	 * Create the frame.
	 */
	public UserNoticeDetail() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(UserNoticeDetail.class.getResource("/photo/caricon.png")));
		setTitle("公告详情");
		...
		lblNewLabel.setIcon(new ImageIcon(UserNoticeDetail.class.getResource("/photo/时间.png")));
		...
		lblNewLabel_2.setIcon(new ImageIcon(UserNoticeDetail.class.getResource("/photo/标题.png")));
		...
		lblNewLabel_4.setIcon(new ImageIcon(UserNoticeDetail.class.getResource("/photo/内容.png")));
		...
		//获取选定行的时间
		Object time=useradvicenotice.notice_time;
