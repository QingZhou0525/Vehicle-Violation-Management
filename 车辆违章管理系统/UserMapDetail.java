...
public class UserMapDetail extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					UserMapDetail frame = new UserMapDetail();
	 ...
	 * Create the frame.
	 */
	public UserMapDetail() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(UserMapDetail.class.getResource("/photo/caricon.png")));
		setTitle("地图代码");
		...
		//获取选定行的时间
		Object time=usermap.historymap_time;
